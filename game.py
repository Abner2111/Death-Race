...
fuente2 = pygame.font.Font('fonts/space_invaders.ttf', 28)
...
#jugador
jugador = Jugador(640, 720, 60, 60, 'Images/Black_viper.png',10)



def rand_screen(): #decide aleatoriamente un banner y colores de botones
    opciones = ['Images/banner.png', (84, 0, 10), (166, 0, 19), (255, 226, 23)]
